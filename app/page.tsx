...
const API_URL =  "http://127.0.0.1:8000" // || process.env.NEXT_PUBLIC_API_URL "http://192.168.1.150:8000"  //
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-blue-50/30 relative overflow-hidden">
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 py-5">
          <div className="flex gap-5">
            ...
            <div className="flex-1 min-w-0">
              <div className="sticky top-[60px] bg-white/90 backdrop-blur-xl z-40 p-4 rounded-xl shadow-lg shadow-slate-900/5 border border-black-200/60 mb-3">
                ...
                <div className="flex gap-2.5">
                  <Button
                    ...
                    variant="outline"
                    className="h-10 border-slate-300 hover:border-blue-400 hover:bg-blue-50/50 text-slate-700 font-medium transition-all duration-200 flex items-center gap-2"
                  >
                  ...
                  <Button
                    ...
                    className="flex-1 h-10 bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white shadow-md shadow-orange-600/25 hover:shadow-lg hover:shadow-orange-600/30 transition-all duration-200 font-semibold"
                  >
                    Find Students
                  </Button>
                  <Button
                    ...
                    variant="outline"
                    className="h-10 border-slate-300 hover:border-slate-400 hover:bg-slate-50 text-slate-700 font-medium transition-all duration-200 flex items-center gap-2 bg-transparent"
                  >
              ...
              {viewMode === "card" ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 mb-8">
                  {displayedStudents.map((student) => (
                    <div
                      ...
                      className={`group cursor-pointer border-2 ${getStatusRingColor(student.placement_status)} rounded-xl p-4 shadow-[0_4px_12px_rgba(0,0,0,0.12)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.18)] transition-all duration-200 relative`}
                    >
                      <button
                        onClick={(e) =>
                ...
                /* Added compact view as table rows */
                <div className="bg-white/95 backdrop-blur-sm border border-slate-200 rounded-xl shadow-lg shadow-slate-900/5 mb-8 overflow-hidden">
                      ...
                      <tbody className="divide-y divide-slate-200">
                        {displayedStudents.map((student) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-xs font-mono text-slate-500">{student.usahsid.toString()}</td>
      ...
      <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
        <DialogContent className="bg-white/95 backdrop-blur-xl border border-slate-200 max-w-4xl mx-auto rounded-xl shadow-2xl max-h-[85vh] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          <DialogHeader>
      ...
      <Dialog open={!!selectedStudent} onOpenChange={() => setSelectedStudent(null)}>
        <DialogContent className="bg-white/95 backdrop-blur-xl border border-slate-200 max-w-xl mx-auto rounded-xl shadow-2xl">
          {selectedStudent && (
            <>
