...
type SearchControlsProps = {
  ...
  onApplyFilters: () => void;
  onFindStudents: (searchOverrides?: {
    query?: string;
    usahsIdQuery?: string;
    photoQuery?: string;
  }) => void;
...
export const SearchControls = memo(function SearchControls({
  ...
  const [photoQueryDraft, setPhotoQueryDraft] = useState(photoQuery);
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2.5 mb-3">
          ...
          <div className="relative">
            ...
            <Input
              ...
              value={photoQueryDraft}
              onChange={(e) => setPhotoQueryDraft(e.target.value)}
              onKeyDown={handleSearchInputKeyDown}
              className="h-10 border-[var(--brand-border-soft)] bg-[var(--brand-surface-elevated)] pl-9 text-[var(--brand-body)] transition-all duration-200 focus:border-[var(--brand-primary)] focus:ring-2 focus:ring-[rgba(0,94,184,0.2)]"
            />
          </div>
